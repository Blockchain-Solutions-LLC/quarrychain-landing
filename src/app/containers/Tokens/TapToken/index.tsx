    ...
    <Content>
      <Container>
        <MainText>
          ...
          <ContentParagraph>
            Quarrychain's TAP token project is a cryptocurrency basic income
            program designed to create a more equitable distribution of water.
            The TAP token project uses an array of machine learning algorithms
            (QVM) to constantly recalculate the gallon value of a TAP token on a
          ...
          <ContentParagraph>
            ...
            use (currently) in the United States of America. Coupled with the
          ...
          <ContentParagraph>
            ...
            comprehensive array of real-time data sets: meteorological, ground
            water deposits, economic trends, consumption rates, and more. The
