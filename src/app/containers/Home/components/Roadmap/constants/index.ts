...
export const roadmapQuarters = [
  ...
  {
    title: "Phase 2",
    items: ["Development of DPoS Network", "QRY-20 Development & Testing","Development of QuarrySwap","Development of QuarryWallet","QuarryChain Private Sale", "Expanding the Genesis Team"],
    color: AppTheme.colors.regular["darkRed"],
    number: 2
  },
  {
    title: "Phase 3",
    items: ["QuarryChain DPoS Network Launch", "QuarrySwap Launch", "QRY-20 Launch", "QuarryWallet Launch", "First QuarryChain Delegate Voting Round", "QuarryChain Public Sale", "CoinMarketCap/CoinGecko Listings", "Development of QuarryWallet Mobile App"],
